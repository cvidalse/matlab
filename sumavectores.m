...
if(length(vector1)==length(vector2))%maneja la excepcion ya que amnos largos deben ser iguales
...
s = repmat('%d,',1,length(vectoraux));%copia los valores de vector auxiliar para sacarlos como raiz
